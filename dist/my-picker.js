...
var myJquery = __webpack_require__(7);
...
var Picker_1 = __webpack_require__(3);
...
Object.defineProperty(exports, "__esModule", { value: true });
var Col_1 = __webpack_require__(4);
var defaultOption_1 = __webpack_require__(5);
var wheel3D_1 = __webpack_require__(6);
...
var Picker = function () {
    function Picker(options) {
        ...
        for (var _i = 0; _i < cols.length; _i++) {
            var _col = cols[_i];
            //设置滚轮
            wheel = new wheel3D_1.Wheel3D(this, _col, this._option, _i);
...
var animationUtil_1 = __webpack_require__(8);
var constant_1 = __webpack_require__(1);
var perspectiveConversion = __webpack_require__(10);
...
var Wheel3D = function () {
    function Wheel3D(picker, col, option, index) {
        ...
        this.index = index;
        //转轮主体
        this.dom = domUtil_1.default('<div class="picker-wheel">' + '<div class="picker-label"><span class="picker-text"></span></div>' + '<ul></ul>' + '<div class="picker-label"><span class="picker-text"></span></div>' + '</div>').css('height', constant_1.default.WHEEL_HEIGHT / 100 + 'em');
        //转轮上面标签的容器，同时也是转动的轴
    ...
    _createClass(Wheel3D, [{
        ...
        */
        ...
        key: "$onSelectItem",
        value: function $onSelectItem(index, value) {}
    }]);
...
Object.defineProperty(exports, "__esModule", { value: true });
var animationUtil = __webpack_require__(9);
exports.default = {
    /**
     * 动画开始函数
     * @param {()=>void} fn             东航的回调
...
var cacheData = __webpack_require__(11);
...
function Frame(picker, option) {
	...
	this.frame.find(".picker-body").css("webkitPerspective", _constant2.default.WHEEL_HEIGHT / 100 + "em").css("mozPerspective", _constant2.default.WHEEL_HEIGHT / 100 + "em").css("msPerspective", _constant2.default.WHEEL_HEIGHT / 100 + "em").css("perspective", _constant2.default.WHEEL_HEIGHT / 100 + "em")[0].addEventListener('touchstart', function (event) {
		event.preventDefault();
		event.stopPropagation();
	});
